...
;(function (a) {
  ...
  function m(a, b) {
    ...
    return (
      c(b, 'toString') && (a.toString = b.toString), c(b, 'valueOf') && (a.valueOf = b.valueOf), a
    )
  }
  function n(a, b) {
    var c, d, e
  ...
  function r(a, b) {
    ...
    return (
      ...
      a.isBefore(b)
        ? (c = q(a, b))
        : ((c = q(b, a)), (c.milliseconds = -c.milliseconds), (c.months = -c.months)),
      c
    )
  }
  function s(a, b) {
  ...
  function G(a) {
    return (
      null == a._isValid &&
        ...
        a._strict &&
          (a._isValid =
            a._isValid && 0 === a._pf.charsLeftOver && 0 === a._pf.unusedTokens.length)),
      a._isValid
    )
  }
  function H(a) {
  ...
  function I(a) {
    for (var b, c, d, e, f = 0; f < a.length; ) {
      for (
        e = H(a[f]).split('-'), b = e.length, c = H(a[f + 1]), c = c ? c.split('-') : null;
        b > 0;
    ...
    return (
      ...
      null === c || (d === a && '' === c)
        ...
        : ('string' == typeof c && (b._i = c = b._locale.preparse(c)),
          tb.isMoment(c) ? new k(c, !0) : (d ? (u(d) ? Z(b) : W(b)) : bb(b), new k(b)))
    )
  }
  function kb(a, b) {
    var c, d
  ...
  ;(pc.DDDD = h(pc.DDD, 3)),
    ...
    (tb.locale = function (a, b) {
      ...
      return (
        a &&
          ((c = 'undefined' != typeof b ? tb.defineLocale(a, b) : tb.localeData(a)),
  ...
  ;(tb.normalizeUnits = function (a) {
    ...
    m((tb.fn = k.prototype), {
      ...
      isDSTShifted: function () {
        return this._a
          ? this.isValid() &&
              w(this._a, (this._isUTC ? tb.utc(this._a) : tb(this._a)).toArray()) > 0
          : !1
      },
      ...
      local: function (a) {
        return (
          this._isUTC &&
            (this.zone(0, a), (this._isUTC = !1), a && this.add(this._dateTzOffset(), 'm')),
          this
        )
      },
      format: function (a) {
      ...
      parseZone: function () {
        return (
          this._tzm ? this.zone(this._tzm) : 'string' == typeof this._i && this.zone(this._i), this
        )
      },
  ...
  ;(tb.duration.fn.asMilliseconds = function () {
    ...
    tb.locale('en', {
      ordinal: function (a) {
        var b = a % 10,
          c =
            1 === A((a % 100) / 10) ? 'th' : 1 === b ? 'st' : 2 === b ? 'nd' : 3 === b ? 'rd' : 'th'
        return a + c
      },
    }),
    (function (a) {
      ...
      return a.defineLocale('be', {
        ...
        ordinal: function (a, b) {
          switch (b) {
            ...
            case 'w':
            case 'W':
              return (a % 10 !== 2 && a % 10 !== 3) || a % 100 === 12 || a % 100 === 13
                ? a + '-ы'
                : a + '-і'
            case 'D':
              return a + '-га'
    ...
    (function (a) {
      ...
      function b(a, b, c) {
        ...
        switch (c) {
          ...
          case 'mm':
            return (d +=
              1 === a ? 'minuta' : 2 === a ? 'minuti' : 3 === a || 4 === a ? 'minute' : 'minut')
          case 'h':
          ...
          case 'MM':
            return (d +=
              1 === a ? 'mesec' : 2 === a ? 'meseca' : 3 === a || 4 === a ? 'mesece' : 'mesecev')
          case 'yy':
