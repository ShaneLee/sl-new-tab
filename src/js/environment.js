...
const emailListEndpoint = `${host}/todos/email`
...
const booksSummaryEndpoint = p => `${host}/book/summary?period=${p}`
...
const githubDark = new Map()
githubDark.set('--background-color', '#0d1117')
githubDark.set('--text-color', '#e6edf3')
githubDark.set('--link-color', '#79c0ff')
githubDark.set('--link-hover-color', '#6e7d8b')
githubDark.set('--highlighted-todo-color', '#1a232e')
githubDark.set('--bright-red-color', '#ff7a72')
githubDark.set('--bright-orange-color', '#d29922')
githubDark.set('--bright-green-color', '#7ee787')
githubDark.set('--blue-color', '#79c0ff')
githubDark.set('--font-family', "'Helvetica Neue', sans-serif")
githubDark.set('--main-color', '#6ac079')
githubDark.set('--darker-main-color', '#56d364')
githubDark.set('--lighter-main-color', '#a5d6ab')
githubDark.set('--dark-grey', '#161b22')
githubDark.set('--light-medium-grey', '#30363d')
githubDark.set('--light-grey', '#8b949e')
githubDark.set('--very-dark', '#0d1117')
githubDark.set('--medium-grey', '#21262d')
...
themes.set('githubDark', githubDark)
